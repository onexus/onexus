 ...
 *
 */
package org.onexus.website.widget.html;

import org.apache.wicket.model.IModel;
import org.onexus.website.api.widget.AbstractWidgetCreator;
import org.onexus.website.api.widget.Widget;

public class HtmlPageCreator extends AbstractWidgetCreator<HtmlPageConfig, HtmlPageStatus> {
    ...
    @Override
    protected Widget<?, ?> build(String componentId, IModel<HtmlPageStatus> statusModel) {
