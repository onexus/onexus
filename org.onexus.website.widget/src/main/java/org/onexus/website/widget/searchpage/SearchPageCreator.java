...
public class SearchPageCreator extends AbstractWidgetCreator<SearchPageConfig, SearchPageStatus> {
    ...
    @Override
    protected Widget<?, ?> build(String componentId, IModel<SearchPageStatus> statusModel) {
