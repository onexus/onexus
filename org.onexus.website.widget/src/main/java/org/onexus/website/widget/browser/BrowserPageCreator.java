...
public class BrowserPageCreator extends AbstractWidgetCreator<BrowserPageConfig, BrowserPageStatus> {
    ...
    @Override
    protected Widget<?, ?> build(String componentId, IModel<BrowserPageStatus> statusModel) {
