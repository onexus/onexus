...
import org.onexus.website.widget.selection.custom.CustomFilter;
import org.onexus.website.widget.selection.custom.ListCustomFilterPanel;
import org.onexus.website.widget.selection.custom.NumericCustomFilterPanel;
        ...
        selector.add(new AjaxFormComponentUpdatingBehavior("onchange") {
            ...
            protected void onUpdate(AjaxRequestTarget target) {
                ...
                if (customFilter == null || customFilter.getType() == null) {
                    ...
                    FiltersWidget.this.addOrReplace(new NumericCustomFilterPanel("customPanel", customFilter, FiltersWidget.this.getConfig().getORI()) {
                        @Override
                        protected void addFilter(AjaxRequestTarget target, FilterConfig filterConfig) {
                            addCustomFilter(target, filterConfig);
                        }
