...
import org.onexus.website.widget.tags.tagstore.ITagStoreManager;
import org.onexus.website.widget.tags.tagstore.TagStore;
...
public class TagColumnItem extends Panel {
    ...
    private TagStore getTagStore() {
        ...
        String baseURI = status.getConfig().getORI().toString();
