...
public final class BufferedFileChannel {
     ...
     *            the file to read from.
     * @param buffer
     *            the {@link ByteBuffer} to use for caching the data.
     * @throws IOException
     *             if any error occurs while creating the
     *             {@link BufferedFileChannel}.
     */
     ...
     * @param bytesToRead
     *            the maximum number of bytes to read from the FileChannel
     ...
     * @throws IOException
     *             if any error occurs while calculating the size.
     */
     ...
     * @throws IOException
     *             if there are less than <code>dst.length</code> bytes
     ...
     *            the arrray to write the data to.
     * @param start
     *            the first position to write the data to.
     * @param length
     ...
     * 
     * @throws IOException
     *             if any error occurs while finishing the channel.
     * @see #close()
     */
     ...
     * 
     * @throws IOException
     *             if any error occurs while closing the {@link FileChannel}.
     * @see #finish()
     */
