...
import static org.onexus.task.executor.loader.tsv.tools.Token.*;

/**
 * This class serves as an efficient constructor for byte arrays. It bears some
 * resemblance to Java's {@link java.lang.StringBuilder}.
 *
...
public final class TokenBuilder {
    ...
    /**
     * Adds a highlight flag. This flag is evaluated by the text renderer in the
     * frontend.
     *
    ...
    /**
     * Adds a norm flag. This flag is evaluated by the text renderer in the
     * frontend.
     *
     * @return self reference
     */
    ...
    /**
     * Adds a new line. This flag is evaluated by the text renderer in the
     * frontend.
     *
     * @return self reference
     */
    ...
    /**
     * Adds a half new line. This flag is evaluated by the text renderer in the
     * frontend.
     *
     * @return self reference
     */
     ...
     * objects, which can be byte arrays or any other object. If a digit is
     * found after %, it is interpreted as insertion position.
     *
    ...
    public TokenBuilder add(final Object str, final Object... ext) {
        ...
        for (int i = 0, e = 0; i < t.length; i++) {
            if (t[i] != '%' || e == ext.length) {
                ...
                add(o instanceof byte[] ? (byte[]) o : o == null ? null : o
                        .toString());
            }
        }
        return this;
     ...
     */
    public void chop() {
        while (size > 0 && ws(chars[size - 1]))
            size--;
        int s = -1;
        while (++s < size && ws(chars[s]))
            ;
        if (s != 0 && s != size)
            Array.move(chars, s, -s, size - s);
        size -= s;
    }

    /**
     * Returns the token as a byte array. Unused array bytes are chopped before
