...
public class TooltipDecorator implements IDecorator {
    ...
    public TooltipDecorator(Collection collection, Field field, String[] parameters) {
        super();
        this.field = field;
    }
    ...
    public void populateCell(WebMarkupContainer cellContainer, String componentId, IModel<IEntity> entity) {
        ...
        cellContainer.add(new Label(componentId, tooltip).setEscapeModelStrings(false));
    }

    @Override
    public String getFormatValue(IEntity entity) {
        return (entity == null ? "" : String.valueOf(entity.get(field.getId())));
    }
