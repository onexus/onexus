...
import org.onexus.collection.store.mysql.adapters.BooleanAdapter;
import org.onexus.collection.store.mysql.adapters.DoubleAdapter;
import org.onexus.collection.store.mysql.adapters.IntegerAdapter;
import org.onexus.collection.store.mysql.adapters.LongAdapter;
import org.onexus.collection.store.mysql.adapters.SQLAdapter;
import org.onexus.collection.store.mysql.adapters.StringAdapter;
...
public class MysqlCollectionDDL implements Serializable {
    private final static Logger LOGGER = LoggerFactory
	    .getLogger(MysqlCollectionDDL.class);
    ...
    public MysqlCollectionDDL(Collection collection) {
	...
	private ColumnInfo(String prefix, Field field) {
	    this.columnName = MysqlUtils.removeNonValidChars(field.getName());
	    this.field = field;
