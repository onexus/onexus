...
import org.onexus.website.widgets.pages.search.SearchPage;
import org.onexus.website.widgets.pages.search.SearchPageConfig;
import org.onexus.website.widgets.pages.search.SearchPageStatus;
import org.onexus.website.widgets.pages.search.SearchType;
...
public class SelectionPanel extends EventPanel {
    ...
    public SelectionPanel(String id, IModel<BrowserPageStatus> pageModel) {
        ...
        add(new BrowserPageLink<ORI>("new") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                for (WidgetConfig config : websiteConfig.getPages()) {
    ...
    protected Query getQuery() {
        WebsiteStatus pageStatus = findParentStatus(getDefaultModel(), WebsiteStatus.class);
